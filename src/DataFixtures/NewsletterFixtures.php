...
class NewsletterFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        $newsletters = [
            ...
            3 => [
                "created_at" => Datetime::createFromFormat("Y-m-d H:i:s", "2021-28-11 11:00:00"),
            ...
            4 => [
                "created_at" => Datetime::createFromFormat("Y-m-d H:i:s", "2021-28-11 12:00:00"),
            ...
            5 => [
                "created_at" => Datetime::createFromFormat("Y-m-d H:i:s", "2021-28-11 13:00:00"),
